            ...
            <div class="product-details">
                ...
                <div class="product-info">
                    ...
                    <div class="social-media">
                        <a href="mailto:dambwedesigns@gmail.com?subject=${encodeURIComponent(`Inquiry about ${product.name}`)}&body=${encodeURIComponent(`I am interested in ${product.name}. Please provide more details.`)}" class="social-icon"><i class="fas fa-envelope"></i></a>
                        <a href="https://wa.me/0897644624?text=${encodeURIComponent(`I am interested in ${product.name}. Please provide more details.`)}" class="social-icon"><i class="far fa-whatsapp"></i></a>
